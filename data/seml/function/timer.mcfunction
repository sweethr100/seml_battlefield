...
execute if score bossbar_min timer matches 0 if score bossbar_sec timer matches 0 run bossbar set time name {"text": "자기장 축소 중..."}
execute if score bossbar_min timer matches 0 if score bossbar_sec timer matches 0 run bossbar set minecraft:time color red
execute if score bossbar_min timer matches 0 if score bossbar_sec timer matches 0 run schedule clear seml:timer
